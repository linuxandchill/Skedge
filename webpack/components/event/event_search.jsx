          ...
          <div className="">
            <div className="white-background">
              <ul className="nav nav-tabs" role="tablist">
                ...
                <li role="presentation" className=""><a href="#past-events" aria-controls="events" role="tab" data-toggle="tab">Past Events</a></li>
              ...
              <div className="tab-content">
                ...
                <div role="tabpanel" className="tab-pane" id="past-events">
                  <PastEventsList />
                </div>
